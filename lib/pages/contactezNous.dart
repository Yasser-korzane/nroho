      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () {
              // l'icone retour en haut a gauche nous permttra de revenir vers la page d'avant(Assistance)
          ...
          children: [
            ...
            Positioned(
              ...
              child: Row(
                children: [
                  new Tab(
                    icon: new Image.asset("assets/images/linkedInLogo.png"),
                  ),
                  SizedBox(width: screenWidth * 0.0244),
                  TextButton(
                    onPressed: () {
                      launch(
                          'https://www.linkedin.com/in/grine-mohammed-205b01238/');
                    },
                    child: Container(
                      decoration: BoxDecoration(
                        border: Border(
